...
function SearchContent() {
  ...
  const [activeTab, setActiveTab] = useState<Tab>(
    (searchParams.get("tab") as Tab) || "web"
  );
  ...
  // Newsletter results — live computed
  ...
  // Real-time web search with debounce
  useEffect(() => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-6 pb-0">
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              placeholder={
                activeTab === "web"
                  ? "Search the web for newsletters, articles, topics..."
            ...
            {!hasQuery && (
              <div className="text-center py-24">
                ...
                <p className="text-gray-500 max-w-sm mx-auto">
                  Type anything above to search for newsletters, articles, and
              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {webResults.map((result, i) => (
                    <WebResultCard key={i} result={result} index={i} />
                  ))}
                </div>
              </>
            )}
